...
public class obstacleDetectionCondtionLeft {
    public float check(float HeroX,float HeroY,obstacle3 obs3,obstacle4 obs4,obstacle5 obs5,obstacle6 obs6,obstacle7 obs7,obstacle8 obs8,obstacle9 obs9,obstacle11 obs11,obstacle12 obs12,obstacle14 obs14,obstacle15 obs15,obstacle16 obs16,obstacle17 obs17,obstacle17_bridge obs17_bridge,obstacle18 obs18,obstacle19 obs19,obstacle20 obs20,obstacle21 obs21,obstacle22 obs22,obstacle23 obs23,obstacle24 obs24,obstacle26 obs26,obstacleHome obsHome,boolean allCheck){
        if(HeroY>obs3.limitY && HeroX<=obs3.limitX) HeroX=obs3.limitX;
        ...
        else if(HeroY>obs19.limitY1 && HeroY<obs19.limitY2 && HeroX>obs19.limitX1 && HeroX<=obs19.limitX2 && !allCheck) HeroX=obs19.limitX2;
        ...
        else if(HeroY>obs22.limitY1 && HeroY<obs22.limitY2 && HeroX>obs22.limitX1 && HeroX<=obs22.limitX2) HeroX=obs22.limitX2;
        else if(HeroY>obs23.limitY1 && HeroY<obs23.limitY2 && HeroX>obs23.limitX1 && HeroX<=obs23.limitX2) HeroX=obs23.limitX2;
        else if(HeroY>obs24.limitY1 && HeroY<obs24.limitY2 && HeroX>obs24.limitX1 && HeroX<=obs24.limitX2) HeroX=obs24.limitX2;
        else if(HeroY>obs26.limitY1 && HeroY<obs26.limitY2 && HeroX>obs26.limitX1 && HeroX<=obs26.limitX2) HeroX=obs26.limitX2;
        else if(HeroY>obsHome.limitY1 && HeroY<obsHome.limitY2 && HeroX>obsHome.limitX1 && HeroX<=obsHome.limitX2) HeroX=obsHome.limitX2;
        return HeroX;
    }
}
