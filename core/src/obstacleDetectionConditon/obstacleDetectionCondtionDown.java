...
public class obstacleDetectionCondtionDown {
    public float check(float HeroX,float HeroY,obstacle1 obs1,obstacle4 obs4,obstacle5 obs5,obstacle6 obs6,obstacle7 obs7,obstacle8 obs8,obstacle9 obs9,obstacle11 obs11,obstacle12 obs12,obstacle14 obs14,obstacle15 obs15,obstacle16 obs16,obstacle17 obs17,obstacle17_bridge obs17_bridge,obstacle18 obs18,obstacle19 obs19,obstacle20 obs20,obstacle21 obs21,obstacle22 obs22,obstacle23 obs23,obstacle24 obs24,obstacle25 obs25,obstacle26 obs26,obstacleHome obsHome){
        ...
        else if(HeroX>obs19.limitX1 && HeroX<obs19.limitX2 && HeroY>obs19.limitY2-15 && HeroY<=obs19.limitY2) HeroY=obs19.limitY2;
        ...
        else if(HeroX>obs22.limitX1 && HeroX<obs22.limitX2 && HeroY>obs22.limitY1 && HeroY<=obs22.limitY2) HeroY=obs22.limitY2;
        else if(HeroX>obs23.limitX1 && HeroX<obs23.limitX2 && HeroY>obs23.limitY1 && HeroY<=obs23.limitY2) HeroY=obs23.limitY2;
        else if(HeroX>obs24.limitX1 && HeroX<obs24.limitX2 && HeroY>obs24.limitY1 && HeroY<=obs24.limitY2) HeroY=obs24.limitY2;
        else if(HeroX>obs26.limitX1 && HeroX<obs26.limitX2 && HeroY>obs26.limitY1 && HeroY<=obs26.limitY2) HeroY=obs26.limitY2;
        else if(HeroX>obsHome.limitX1 && HeroX<obsHome.limitX2 && HeroY>obsHome.limitY1 && HeroY<=obsHome.limitY2) HeroY=obsHome.limitY2;
        else if(HeroX>obs25.limitX && HeroY>obs25.limitY1 && HeroY<=obs25.limitY2) HeroY=obs25.limitY2;
        return HeroY;
    }
}
